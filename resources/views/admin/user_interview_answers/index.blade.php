...
@section('content')
    ...
    @can('user_interview_answer_create')
    <p>
        <a href="{{ route('admin.user_interview_answers.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped {{ count($user_interview_answers) > 0 ? 'datatable' : '' }} @can('user_interview_answer_delete') dt-select @endcan">
                <thead>
                    <tr>
...
@section('javascript') 
    <script>
        @can('user_interview_answer_delete')
            window.route_mass_crud_entries_destroy = '{{ route('admin.user_interview_answers.mass_destroy') }}';
        @endcan
