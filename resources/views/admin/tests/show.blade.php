...
<li role="presentation" class="active"><a href="#testanswers" aria-controls="testanswers" role="tab" data-toggle="tab">Test answers</a></li>
<li role="presentation" class=""><a href="#usertestanswers" aria-controls="usertestanswers" role="tab" data-toggle="tab">User test answers</a></li>
</ul>

<!-- Tab panes -->
<div class="tab-content">
    
<div role="tabpanel" class="tab-pane active" id="testanswers">
<table class="table table-bordered table-striped {{ count($test_answers) > 0 ? 'datatable' : '' }}">
    <thead>
        <tr>
...
<div role="tabpanel" class="tab-pane " id="usertestanswers">
