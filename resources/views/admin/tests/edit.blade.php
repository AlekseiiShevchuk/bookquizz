    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="test-answers">
                    @forelse(old('test_answers', []) as $index => $data)
                        @include('admin.tests.test_answers_row', [
                            'index' => $index
                        ])
                    @empty
                        @foreach($test->testAnswer as $item)
                            @include('admin.tests.test_answers_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
...
@section('javascript')
    ...
    <script type="text/html" id="test-answers-template">
        @include('admin.tests.test_answers_row', [
            'index' => '_INDEX_'
        ])
    </script>
