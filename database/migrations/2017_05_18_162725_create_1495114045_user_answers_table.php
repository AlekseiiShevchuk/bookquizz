    ...
    public function up()
    {
        if(! Schema::hasTable('user_answers')) {
            Schema::create('user_answers', function (Blueprint $table) {
                ...
                $table->integer('possible_answer_id')->unsigned()->nullable();
                $table->foreign('possible_answer_id', '38003_591da13de28ef')->references('id')->on('possible_answers')->onDelete('cascade');
